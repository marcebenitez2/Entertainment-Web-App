    ...
    <div className="sidebar">
      ...
      <div className="nav">
        <svg
          ...
          fill= {actual_page === "home_page" ? "#00bcd4" : "currentColor"}
          viewBox="0 0 20 20"
          xmlns="http://www.w3.org/2000/svg"
          onClick={goHome}
        >
        ...
        <svg
          className="nav_button"
          fill= {actual_page === "movie_genre" ? "#00bcd4" : "currentColor"}
          viewBox="0 0 20 20"
          xmlns="http://www.w3.org/2000/svg"
          onClick={goMovieGengres}
        >
        ...
        <svg
          className="nav_button"
          fill= {actual_page === "tv_genres" ? "#00bcd4" : "currentColor"}
          viewBox="0 0 20 20"
          xmlns="http://www.w3.org/2000/svg"
          onClick={goTvGenres}
        >
        ...
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill= {actual_page === "favorite" ? "#00bcd4" : "currentColor"}
          viewBox="0 0 512 512"
          cursor={"pointer"}
          width={"2.6rem"}
          onClick={goFav}
